...
The goal for this project is to identify students who might need early intervention before they fail to graduate. The dataset on students' performance was analyzed and different classification models were developed and compared to predict the likelihood that a given student will pass, quantifying whether an intervention is necessary.
